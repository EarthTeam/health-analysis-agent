                    ...
                    <div className="space-y-6 animate-in fade-in slide-in-from-right-4 duration-300">
                        <div className="p-4 bg-blue-50/50 border border-blue-100 rounded-xl mb-4">
                            <p className="text-sm text-blue-700 leading-relaxed">
                                <strong>Morning Autonomic Snapshot:</strong> Morpheus measures your nervous system state at wake-up. It reflects your current regulation, not your overnight sleep.
                            </p>
                        </div>
                        <div className="grid gap-4">
                            <div>
                                <label className="block text-sm font-medium mb-2">Wake-State Readiness (%)</label>
                                <input
                                    type="number"
                            ...
                            <div>
                                <label className="block text-sm font-medium mb-2">Wake-State HRV</label>
                                <input
                                    type="number"
                                    className="w-full p-3 border border-input rounded-xl focus:ring-2 focus:ring-primary/20 outline-none text-lg"
                                    value={formData.mHrv ?? ""}
