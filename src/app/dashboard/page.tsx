        ...
        return (
            <div className="flex flex-col items-center justify-center p-12 bg-card rounded-2xl border border-dashed border-border text-center">
                ...
                <div className="flex gap-4">
                    ...
                    <a href="/bulk-entry" className="px-4 py-2 bg-secondary text-foreground rounded-lg font-medium hover:bg-secondary/80 transition-colors">
                        Bulk Entry
                    </a>
                </div>
            </div>
                    ...
                    <div className="bg-card rounded-2xl p-6 border border-border shadow-sm">
                        ...
                        <p className="text-xs text-muted-foreground mt-2 leading-relaxed">
                            {assessment.signalTension
                                ? "Performance Conflict: Your Wake-State 'engine' is ready, but the Oura/Whoop 'battery' is still lagging behind."
                                : "Systemic Alignment: Your ability to perform matches your depth of recovery. No 'wake-state vs. battery' conflict."}
                        </p>
                    </div>
