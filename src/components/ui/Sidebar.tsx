...
const navItems = [
    ...
    { name: "Bulk Entry", href: "/bulk-entry", icon: Activity },
        ...
        <aside className="hidden md:flex w-64 bg-card border-r border-border h-screen flex-col p-4 shadow-sm z-10">
            <div className="flex items-center gap-3 px-2 mb-8 mt-2">
                ...
                <div>
                    ...
                    <span className="text-[10px] font-bold text-primary bg-primary/10 px-1.5 py-0.5 rounded-md mt-1 inline-block">v2.14.2</span>
                </div>
            </div>
